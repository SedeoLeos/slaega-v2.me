...
import TemplateIvoire from './templates/TemplateIvoire';
import TemplateVerde  from './templates/TemplateVerde';
...
export default function CVDocumentRenderer({ data, template, palette, sections }: Props) {
  ...
  if (template === 'duo')   return <TemplateDuo    data={data} palette={palette} sections={sections} />;
  if (template === 'orbit') return <TemplateOrbit  data={data} palette={palette} sections={sections} />;
  if (template === 'nova')  return <TemplateNova   data={data} palette={palette} sections={sections} />;
  if (template === 'pulse') return <TemplatePulse  data={data} palette={palette} sections={sections} />;
  if (template === 'supra') return <TemplateSupra  data={data} palette={palette} sections={sections} />;
  if (template === 'hello')  return <TemplateHello  data={data} palette={palette} sections={sections} />;
  if (template === 'mosaic') return <TemplateMosaic data={data} sections={sections} />;
  if (template === 'ivoire') return <TemplateIvoire data={data} sections={sections} />;
  if (template === 'verde')  return <TemplateVerde  data={data} sections={sections} />;
