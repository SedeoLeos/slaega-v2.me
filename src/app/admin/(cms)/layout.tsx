          ...
          <AdminShell
            ...
            <aside className="w-full h-full flex flex-col bg-zinc-900 border-r border-zinc-800/60">
              ...
              <nav className="flex-1 overflow-y-auto dark-scroll px-3 py-4 space-y-0.5">
                ...
                <AdminNavItem href="/admin/process">
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.75}
                ...
                <AdminNavItem href="/admin/pensees">
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.75}
                ...
                <div className="pt-4">
                  ...
                  <AdminNavItem href="/admin/ticker">
                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.75}
                  ...
                  <AdminNavItem href="/admin/terminal">
                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.75}
                  ...
                  <AdminNavItem href="/admin/value-cards">
                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.75}
